...
options.register('outFilename', 'JetTaggingVariables_ttjets_80X.root',
...
## Input files
inputFiles = ['/afs/cern.ch/work/f/ferencek/MC13TeV_TTJets_powheg_pythia8_MergedJetTree.root']
